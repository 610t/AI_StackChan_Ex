...
#include "ModuleLLMEXTTTS.h"


ModuleLLMEXTTTS::ModuleLLMEXTTTS(){

}


void ModuleLLMEXTTTS::stream(String text){
  int start = 0;
  int end = 0;
  ...
  while(1){    
    ...
    module_llm.exttts.inference(tts_work_id, sub_text.c_str(), 10000);
